...
class CsvMyTrackParameterWriter final : public IWriter {
 public:
  struct Config {
  ...
  CsvMyTrackParameterWriter(const Config& config, Acts::Logging::Level level);

  /// Virtual destructor
  ~CsvMyTrackParameterWriter() override;
